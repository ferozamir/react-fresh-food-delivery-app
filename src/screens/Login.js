        ...
        return (
            <div>
                ...
                <div className="container-fluid py-5 bg-light">
                    {isRegisterForm ?
                        <div className="col-lg-6 col-md-8 col-sm-12 mx-auto bg-white shadow p-5 rounded">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 mx-auto bg-white shadow p-5 rounded">

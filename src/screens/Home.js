      ...
      <div>
              ...
              <div className="container">
                <div className="row justify-content-center">
                  ...
                  <div className="col-lg-2 col-md-2 col-sm-12">
                    <button type="button" className="btn btn-warning mb-2 text-uppercase btn-block rounded-3" onClick={this.handleSearchBar}><b>Search</b></button>
                  </div>
                </div>
              </div>
        ...
        <div className="container-fluid py-2 bg-warning">
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-12">
              <p className="my-3 text-lg-right text-md-right text-center text-white font-weight-bold"><b className="mr-2 h5 font-weight-bold">18</b>Restaurant</p>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12">
              <p className="my-3 text-center text-white font-weight-bold"><b className="mr-2 h5 font-weight-bold">9</b>People Served</p>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12">
              <p className="my-3 text-lg-left text-md-left text-center text-white font-weight-bold"><b className="mr-2 h5 font-weight-bold">44</b>Registered Users</p>
            </div>
          </div>
        </div>
        ...
        <div className="container-fluid text-center py-4">
          <div className="py-4">
            ...
            <p>Simply browse, order, and enjoy a wide variety of delicious dishes delivered straight to your doorstep.</p>
          </div>
          <div className="container">
            <div className="row">
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                  <img className='home-image' alt="Choose A Restaurant" src={require("../assets/images/how-to-work2.png")} />
                </span>
                <h3 className="h3 mb-4">Choose A Restaurant</h3>
                <p className="mb-4">Delicious cuisine and impeccable service await at our renowned restaurant.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                  <img className='home-image' alt="Choose A Tasty Dish" src={require("../assets/images/how-to-work3.png")} />
                </span>
                <h3 className="h3 mb-4">Choose A Tasty Dish</h3>
                <p className="mb-4">Savor the flavors of our mouthwatering specialty dish, crafted with culinary expertise and served to perfection.</p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                  <img className='home-image' alt="Pick Up Or Delivery" src={require("../assets/images/how-to-work1.png")} />
                </span>
                <h3 className="h3 mb-4">Pick Up Or Delivery</h3>
                <p className="mb-4">Get your favorite dishes conveniently delivered or opt for a quick and easy pick-up option.</p>
              </div>
            </div>
          </div>
        </div>
